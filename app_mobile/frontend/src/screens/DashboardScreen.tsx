...
import { View, StyleSheet, SafeAreaView, Text, TouchableOpacity, Image, Platform, ScrollView, Animated, StatusBar } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  headerBackground: {
    paddingTop: Platform.OS === 'android'
      ? (StatusBar.currentHeight ?? 24) + 4  // Android : compense la status bar translucide
      : 10,
    paddingBottom: 40, 
